                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4 group">
                    ...
                    <div>
                      ...
                      <a href="tel:+61493597005" className="text-base font-black text-slate-900 hover:text-[#16a34a] transition-colors">+61 493 597 005</a>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 group">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-50 text-slate-500 border border-slate-100 transition-all group-hover:border-[#16a34a]/30 group-hover:text-[#16a34a] group-hover:bg-white shadow-sm">
                    ...
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-600 leading-none mb-1">WhatsApp</p>
                      <a href="https://wa.me/61493597005" target="_blank" rel="noopener noreferrer" className="text-base font-black text-slate-900 hover:text-[#16a34a] transition-colors">+61 493 597 005</a>
                    </div>
                  </div>
                </div>
              </div>
